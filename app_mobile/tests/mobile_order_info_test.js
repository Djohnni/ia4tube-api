...
function printUsageAndExit() {
  console.log("IA4Tube Mobile V1 - teste de consulta de pedido");
  console.log("");
  console.log("Uso:");
  console.log("  TOKEN=\"seu_jwt\" PEDIDO_ID=\"20260525_180819\" node app_mobile/tests/mobile_order_info_test.js");
  console.log("");
  console.log("Variaveis opcionais:");
  console.log("  API_BASE=\"https://ia4tube-api.onrender.com\"  # padrao");
  console.log("");
  ...
  console.log("  node app_mobile\\tests\\mobile_order_info_test.js");
  console.log("");
  process.exit(1);
}
...
async function main() {
  ...
  const url = `${API_BASE}/pedidos/${encodeURIComponent(PEDIDO_ID)}/info`;
