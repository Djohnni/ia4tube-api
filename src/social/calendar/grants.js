...
function createCalendarGrants(secret, clock = Date.now) {
  ...
  function issue({ companyId, userId, binding, revision, planningId, quantity }) {
    ...
    const value = { purpose: "calendar_publish", companyId, userId, binding, preferenceRevision: revision, planningId, quantity,
