...
const SENSITIVE_TEXT_KEY =
  "(?:authorization|proxy-authorization|access_token|refresh_token|id_token|oauth_code|authorization_code|token|client_secret|api_key|apikey|jwt|password|senha|secret|signature|private_key|encryption_key|hmac_key|fcm_token|bot_token|cookie|set-cookie|oauth_state|state_token|state|code_verifier|pkce_verifier|nonce|whatsapp|telefone|phone|email|cpf|cnpj|iv|tag|ciphertext|fingerprint)";
