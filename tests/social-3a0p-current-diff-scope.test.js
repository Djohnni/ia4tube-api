...
test("o diff físico atual contra a base contém somente arquivos do harness", () => {
...
test("produto, migrations, dependências e servidor permanecem byte a byte na base", () => {
